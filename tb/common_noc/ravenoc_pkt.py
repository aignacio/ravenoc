...
class RaveNoC_pkt:
    ...
    Args:
        ...
        msg: Message in string format that'll compose the payload of the packet
    ...
    """
    def __init__(self, cfg, msg=None, src_dest=(None,None), virt_chn_id=None):
        # Head Flit:
        ...
        self.cfg = cfg
        if msg == None:
            msg = self._get_random_msg(self.max_bytes_hflit)
        if virt_chn_id == None:
        ...
        if length_bytes <= self.max_bytes_hflit:
            ...
            self.msg = bytearray(self.hflit.to_bytes(num_bytes_per_flit,"little"))
        else:
            ...
            if length_bytes%num_bytes_per_flit != 0:
                while len(msg)%num_bytes_per_flit != 0:
                    msg += '\0'
